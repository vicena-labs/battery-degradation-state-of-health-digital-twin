...
axh.text(.025,.68,'VICENA  |  OPEN RESEARCH TWIN',color='#31d5c8',fontsize=10,weight='bold',transform=axh.transAxes); axh.text(.025,.28,'Battery Degradation and State-of-Health Digital Twin',color='white',fontsize=19,weight='bold',transform=axh.transAxes); axh.text(.975,.5,'v0.4.0  |  MIT',ha='right',va='center',color='white',fontsize=10,transform=axh.transAxes)
