...
axh.text(.975,.5,'v0.1.0  |  MIT',ha='right',va='center',color='white',fontsize=10,transform=axh.transAxes)
...
vals=[('Measured rows',f"{m['n_rows']}"),('Held-out groups',f"{m['test_groups']}"),('SOH MAE',f"{m['mae']:.3f}"),('Baseline MAE',f"{m['baseline_mae']:.3f}"),('Tests','3 passed')]
